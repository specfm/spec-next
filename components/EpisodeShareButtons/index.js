...
class EpisodeShareButtons extends React.Component<Props> {
  render() {
    ...
    return (
      <Container>
        <a
          href={`https://www.facebook.com/sharer/sharer.php?u=https://spec.fm/podcasts/${
            podcast.slug
          }/${episode.id}`}
          target="_blank"
        ...
        <a
          href={`https://twitter.com/share?text=${episode.title} on @${
            podcast.twitterUsername
          }&url=https://spec.fm/podcasts/${podcast.slug}/${episode.id}`}
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <CopyLinkButton
          text={`https://spec.fm/podcasts/${podcast.slug}/${episode.id}`}
        >
          Copy
        </CopyLinkButton>
      </Container>
