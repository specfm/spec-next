              ...
              return (
                <Link href={'/'} key={statObj.id}>
                  <a>
                    <Card>
                      <ContentContainer>
                        <PodcastArt src={'/static/og-image.jpg'} alt={"Network total"} />
                        <Meta>
                          <Title>Network Total</Title>
                          <Subtitle>Current: {statObj.totals.current.toLocaleString()}</Subtitle>
                          {
                            range !== 'all' &&
                            <React.Fragment>
                              <Subtitle>Previous: {statObj.totals.previous.toLocaleString()}</Subtitle>
                              <Growth positive={positive}>{statObj.difference.toString()}%</Growth>
                            </React.Fragment>
                          }
                        </Meta>
                      </ContentContainer>
            ...
            return (
              <Link href={`/podcasts/${statObj.podcast.slug}`} key={statObj.id}>
                <a>
                  <Card>
                    <ContentContainer>
                      <PodcastArt src={statObj.podcast.artworkUrl} alt={statObj.podcast.name} />
                      <Meta>
