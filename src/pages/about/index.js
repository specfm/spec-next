      ...
      <Page showEmailCapture={false} dataCy="about-view">
        ...
        <Container>
          <ContentContainer style={{ paddingTop: '88px' }}>
            ...
            <p>
              Spec exists to encourage the right conversations, promote the
              right tools and processes, and provide a culture of constant
              learning and improvement to the global community of developers and
              designers. We produce top-rated podcasts and content resources for
              developers and designers in every stage of their career, and we
              engage the community in discussion on a daily basis.
            </p>
            ...
            <p>
              ...
              Developer Tea — were started by three individuals who wanted to
              talk about the work they do every day. After an amazing response
              from the web community, we’ve teamed up to create the Spec Network
              to help designers and developers to learn, find great resources
              and connect with one another.
            </p>

            <p>
              Today our podcasts are downloaded more than 100,000 times per week
              and we’re working to create new shows to provide the most
              up-to-date resources and information for the design & development
              community!
            </p>
            ...
            <p>
              ...
              to hang out with thousands of like-minded designers and
              developers.
            </p>
        ...
        {shuffledHosts && <HostsGrid cols={4} hosts={shuffledHosts} />}
      </Page>
    );
  }
}
